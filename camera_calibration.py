...
CHESSBOARD_SIZE = (24, 17)  # Number of inner corners per chessboard row and column
SQUARE_SIZE = 2.5         # Size of a square in centimeters
CALIBRATION_IMAGES_PATH = r'calibration_images\*.jpg'  # Path to calibration images
OUTPUT_DIRECTORY = 'calibration_results'  # Directory to save calibration results
